...
export function IssuesCard({ title, description, img, url, issuuLink, archived }: { title: string; description: string; img: string; url: string; issuuLink: string; archived: boolean }) {
	return (
