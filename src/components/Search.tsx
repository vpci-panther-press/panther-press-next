...
export function Search() {
  ...
  return (
    <form
      onSubmit={onSubmit}
      className="flex items-center gap-2 rounded-md border border-gray-300 bg-white px-2 py-1 text-sm transition hover:bg-gray-50 dark:border-gray-700 dark:bg-zinc-900 dark:text-gray-200 dark:hover:bg-zinc-800"
    >
