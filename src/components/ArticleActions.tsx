...
export function ArticleActions({
  ...
  return (
    <div
      className={cn(
        "flex flex-row items-center rounded-lg border border-zinc-300 bg-zinc-200 px-3 py-2 align-middle dark:border-gray-700 dark:bg-[rgba(39,39,42,0.5)]",
        className,
      )}
    >
      <button
        onClick={toggleLike}
        className={cn(
          "flex w-1/2 flex-col items-center justify-center pr-3 transition-colors",
          liked && "text-cs-primary dark:text-cs-secondary",
        )}
