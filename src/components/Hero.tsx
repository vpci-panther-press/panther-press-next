			...
			<div className="grid gap-4 md:grid-cols-2 md:items-center md:gap-8 xl:gap-20">
				<div>
					...
					<p className="mt-7 text-lg text-gray-800 dark:text-gray-400">
						Welcome to the Panther Press, Victoria Park Collegiate Institute&apos;s student-run newspaper. We are a group of students who are passionate about writing and journalism.
					</p>
