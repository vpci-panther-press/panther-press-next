...
export default function PhotographyPage() {
	return (
		<main id="content" role="main" className="h-screen px-4 py-10 text-center sm:px-6 lg:px-8">
			<h1 className="block text-2xl font-bold sm:text-4xl dark:text-white">Coming Soon</h1>
			<p className="mt-3 text-lg text-stone-600 dark:text-gray-300">This page is still under development, please check back later!</p>
